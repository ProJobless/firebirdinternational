...
class User_Model extends CI_Model {
	...
	************************************************************/
	...
	function send_verification_email(){
		...
		$user_id= random_string('alnum',16);
		$this->email->message('Hello,'.$this->session->userdata('user_name').', \r\n Thank you for creating account with Firebird. Please click this link to verify your  account: '.base_url().'user/emailverification/'.$user_id.'\r\n Thank you!');
	...
	*/
	...
	function check_verification_email($userid, $params){
